...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(6), __webpack_require__(10).setImmediate))
  ...
  return _c("div", { staticClass: "panel panel-default" }, [
    ...
    _c("div", { staticClass: "panel-body" }, [
      _vm.pages
        ...
        : _vm._e(),
      _vm._v(" "),
      !_vm.pages ? _c("p", [_vm._v("Категорий пока нет")]) : _vm._e()
    ])
  ])
}
var staticRenderFns = [
  ...
  return _c("div", { staticClass: "panel panel-default" }, [
    ...
    _c("div", { staticClass: "panel-body" }, [
      _vm.workList
        ...
        : _vm._e(),
      _vm._v(" "),
      !_vm.workList ? _c("p", [_vm._v("Новостей пока нет")]) : _vm._e()
    ])
  ])
}
var staticRenderFns = [
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        addRole: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(userId, roleId) {
                var _this3 = this;
...
var render = function() {
  ...
  return _c("div", { staticClass: "panel panel-default" }, [
    _c("div", { staticClass: "panel-heading" }, [
      _vm._v("Просмотр пользователя " + _vm._s(_vm.user.user.name))
    ]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _c("p", [_vm._v("\n            Включенеые роли:\n        ")]),
        _vm._v(" "),
        _vm._l(_vm.user.userRoles, function(role) {
          return _c("ul", [
            _vm.user.userRoles.length > 1
              ? _c("li", [
                  ...
                  _c(
                    "a",
                    {
                      ...
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          _vm.removeRole(_vm.user.user.id, role.id)
                        }
                      }
                    },
                    [_vm._v("Выключить")]
              ...
              _c(
                "a",
                {
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      _vm.addRole(_vm.user.user.id, role.id)
                    }
                  }
                },
                [_vm._v("Включить")]
          ...
          ? _c(
              ...
              [
                _c("p", [
                  _vm._v(
                    "\n                Работы пользователя (" +
                      _vm._s(_vm.user.works.length) +
                      ")\n            "
                  )
                ]),
                _vm._v(" "),
                _vm._l(_vm.user.works, function(work) {
                  return _c("ul", [_c("li", [_vm._v(_vm._s(work.workName))])])
                })
              ],
              2
            )
        ...
        _c(
          "a",
          {
            ...
            on: {
              click: function($event) {
                $event.preventDefault()
                _vm.removeUser(_vm.user.user.id)
              }
            }
          },
          [_vm._v("Удалить")]
