                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                console.log(id);
                                __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/catalog/' + id + '/remove').then(function (response) {
                                    if (response.success) {
                                        _this.getCategories();
                                    }
                                }, function (error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue2_editor__ = __webpack_require__(3);
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                if (this.categoryId) {
                                    __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/catalog/' + this.categoryId).then(function (response) {
            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee() {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/pages/list').then(function (response) {
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(slug) {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/pages/' + slug + '/delete').then(function (response) {
                                    if (response.success) {
                                        _this2.getPages();
                                    }
                                });
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                if (this.pageId) {
                                    __WEBPACK_IMPORTED_MODULE_2__services_http__["a" /* default */].transport('/api/manager/pages/' + this.pageId).then(function (response) {
                                        _this2.form.slug = response.slug;
                                        _this2.form.name = response.name;
                                        _this2.form.content = response.content;
                                        _this2.form.id = response.slug;
                                    });
                                }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteWork: function deleteWork(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/work/' + id + '/delete').then(function (response) {
                if (response.success) {
                    _this2.getWorks();
                }
            });
        ...
        toggleApprove: function toggleApprove(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/work/approve/' + id).then(function (response) {
                if (response.success) {
                    _this3.getWorks();
                }
            });
            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee() {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/user/list').then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUser: function getUser() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/user/' + this.userId).then(function (response) {
                _this.user = response.user;
                _this.works = response.works;
                _this.userRoles = response.userRoles;
            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(userId, roleId) {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/user/role/remove/' + userId + '/' + roleId).then(function (response) {
                                    if (response.success) {
                                        _this2.getUser();
                                    }
                                });
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(userId, roleId) {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1__services_http__["a" /* default */].transport('/api/manager/user/role/add/' + userId + '/' + roleId).then(function (response) {
                                    if (response.success) {
                                        _this3.getUser();
                                    }
                                });
