...
#### О проекте
Реальный проект для людей знамающимися искуством recycle art. В качестве бэкэнда, использован фрейворк Laravel 5.5, фронтенд - jquery основной сайт, Vue.js админка.
