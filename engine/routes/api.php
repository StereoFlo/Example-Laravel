...
Route::group(['middleware' => 'auth:api'], function () {
    Route::group(['middleware' => 'isModerator'], function () {
        ...
        Route::get('/manager/catalog/{categoryId}', 'Manager\\Api\\Catalog@show')->where('categoryId', '[0-9]+');
        ...
        Route::get('/manager/pages/{pageId}', 'Manager\\Api\\StaticPage@show')->where('pageId', '[a-zA-Z0-9]+');
        ...
        Route::get('/manager/work/approve/{workId}', 'Manager\\Work@approve')->where('workId', '[0-9]+');
