        ...
        <div class="container">
            ...
            <form class="registrationForm registrationForm_dark form" method="POST" action="{{ route('register') }}">
                ...
                <div class="inputGroup{{ $errors->has('location') ? ' has-error' : '' }}">
                    ...
                    <input id="location" class="registrationForm__location" type="text" name="location" value="{{ old('location') }}" required autofocus>
                ...
                <div class="inputGroup{{ $errors->has('phone') ? ' has-error' : '' }}">
                    ...
                    <input id="phone" class="registrationForm__phone" type="text" name="phone" value="{{ old('phone') }}" required autofocus>
                ...
                <div class="inputGroup{{ $errors->has('about') ? ' has-error' : '' }}">
                    ...
                    <input id="about" class="registrationForm__about" type="text" name="about" value="{{ old('about') }}" required autofocus>
                ...
                <div class="inputGroup{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <input id="email" class="registrationForm__email" type="email" name="email" value="{{ old('email') }}" required autofocus>
